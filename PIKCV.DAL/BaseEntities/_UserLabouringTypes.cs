...
namespace PIKCV.DAL
{
	public abstract class _UserLabouringTypes : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _UserLabouringTypes()
		{
			this.QuerySource = "UserLabouringTypes";
			this.MappingName = "UserLabouringTypes";
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserLabouringTypesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _UserLabouringTypes.PropertyNames.RowID;
					ht[UserID] = _UserLabouringTypes.PropertyNames.UserID;
					ht[LabouringTypeID] = _UserLabouringTypes.PropertyNames.LabouringTypeID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _UserLabouringTypes.ColumnNames.RowID;
					ht[UserID] = _UserLabouringTypes.ColumnNames.UserID;
					ht[LabouringTypeID] = _UserLabouringTypes.ColumnNames.LabouringTypeID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserLabouringTypesInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserLabouringTypesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserLabouringTypesDelete]";
