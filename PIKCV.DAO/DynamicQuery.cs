...
namespace PIKCV.DAO
{
	abstract public class DynamicQuery
	{
		...
		///
        /// 	' Sort
        /// 	prds.Query.AddOrderBy(prds.ColumnNames.ProductName, PIKCV.DAO.WhereParameter.Dir.ASC)
		/// 	
        /// 	' Load it
        /// 	prds.Query.Load()
		/// 	
		...
		///
		/// 	// Sort
		/// 	prds.Query.AddOrderBy(Products.ColumnNames.ProductName, PIKCV.DAO.WhereParameter.Dir.ASC);
		/// 	
		/// 	// Load it
		/// 	prds.Query.Load();
		///
