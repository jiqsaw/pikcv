<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TemporaryUsersCVPreview.aspx.cs" Inherits="TemporaryUsers_TemporaryUsersCVPreview" %>

<%@ Register Src="../UserControls/Employee/Membership/uCVPreview.ascx" TagName="uCVPreview"
    TagPrefix="uc1" %>
...
<body>
    ...
    <div id="contentPad" style="padding: 20px; text-align: left;">
        <uc1:uCVPreview ID="UCVPreview1" runat="server" />
