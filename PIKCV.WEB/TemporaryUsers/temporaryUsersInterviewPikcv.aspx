<%@ Page Language="C#" AutoEventWireup="true" CodeFile="temporaryUsersInterviewPikcv.aspx.cs" Inherits="TemporaryUsers_temporaryUsersInterviewPikcv" %>

<%@ Register Src="../UserControls/Employee/Membership/uInterviewPikcv.ascx" TagName="uInterviewPikcv"
    TagPrefix="uc1" %>
...
<body>
    ...
    <div id="contentPad" style="padding: 20px; text-align: left;">
        <uc1:uInterviewPikcv ID="UInterviewPikcv1" runat="server" />
    </div>
    </form>
</body>
</html>
