...
namespace PIKCV.DAL
{
	public abstract class _ForeignLanguages_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _ForeignLanguages_ML()
		{
			this.QuerySource = "ForeignLanguages_ML";
			this.MappingName = "ForeignLanguages_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ForeignLanguages_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ForeignLanguages_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter ForeignLanguageName
			{
				get
				{
					return new SqlParameter("@ForeignLanguageName", SqlDbType.NVarChar, 24);
				}
			}
		...
		{  
            ...
            public const string ForeignLanguageName = "ForeignLanguageName";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _ForeignLanguages_ML.PropertyNames.RowID;
					ht[ForeignLanguageID] = _ForeignLanguages_ML.PropertyNames.ForeignLanguageID;
					ht[LanguageID] = _ForeignLanguages_ML.PropertyNames.LanguageID;
					ht[ForeignLanguageName] = _ForeignLanguages_ML.PropertyNames.ForeignLanguageName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _ForeignLanguages_ML.ColumnNames.RowID;
					ht[ForeignLanguageID] = _ForeignLanguages_ML.ColumnNames.ForeignLanguageID;
					ht[LanguageID] = _ForeignLanguages_ML.ColumnNames.LanguageID;
					ht[ForeignLanguageName] = _ForeignLanguages_ML.ColumnNames.ForeignLanguageName;
		...
		{  
            ...
            public const string ForeignLanguageName = "s_ForeignLanguageName";
		...
		public virtual string ForeignLanguageName
	    {
			get
	        {
				return base.Getstring(ColumnNames.ForeignLanguageName);
			}
			set
	        {
				base.Setstring(ColumnNames.ForeignLanguageName, value);
			}
		}
		...
		public virtual string s_ForeignLanguageName
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.ForeignLanguageName) ? string.Empty : base.GetstringAsString(ColumnNames.ForeignLanguageName);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.ForeignLanguageName);
				else
					this.ForeignLanguageName = base.SetstringAsString(ColumnNames.ForeignLanguageName, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter ForeignLanguageName
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.ForeignLanguageName, Parameters.ForeignLanguageName);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter ForeignLanguageName
		    {
				get
		        {
					if(_ForeignLanguageName_W == null)
	        	    {
						_ForeignLanguageName_W = TearOff.ForeignLanguageName;
					}
					return _ForeignLanguageName_W;
				}
			}
			...
			private WhereParameter _ForeignLanguageName_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter ForeignLanguageName
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.ForeignLanguageName, Parameters.ForeignLanguageName);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _ForeignLanguageName_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguages_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguages_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguages_MLDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.ForeignLanguageName);
			p.SourceColumn = ColumnNames.ForeignLanguageName;
			p.SourceVersion = DataRowVersion.Current;
