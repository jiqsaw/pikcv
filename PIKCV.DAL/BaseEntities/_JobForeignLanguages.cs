...
namespace PIKCV.DAL
{
	public abstract class _JobForeignLanguages : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _JobForeignLanguages()
		{
			this.QuerySource = "JobForeignLanguages";
			this.MappingName = "JobForeignLanguages";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobForeignLanguagesLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobForeignLanguagesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobForeignLanguages.PropertyNames.RowID;
					ht[JobID] = _JobForeignLanguages.PropertyNames.JobID;
					ht[ForeignLanguageID] = _JobForeignLanguages.PropertyNames.ForeignLanguageID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobForeignLanguages.ColumnNames.RowID;
					ht[JobID] = _JobForeignLanguages.ColumnNames.JobID;
					ht[ForeignLanguageID] = _JobForeignLanguages.ColumnNames.ForeignLanguageID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobForeignLanguagesInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobForeignLanguagesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobForeignLanguagesDelete]";
