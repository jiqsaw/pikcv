...
namespace PIKCV.DAL
{
	public abstract class _Levels_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Levels_ML()
		{
			this.QuerySource = "Levels_ML";
			this.MappingName = "Levels_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Levels_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Levels_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter LevelName
			{
				get
				{
					return new SqlParameter("@LevelName", SqlDbType.NVarChar, 16);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Levels_ML.PropertyNames.RowID;
					ht[LevelID] = _Levels_ML.PropertyNames.LevelID;
					ht[LanguageID] = _Levels_ML.PropertyNames.LanguageID;
					ht[LevelName] = _Levels_ML.PropertyNames.LevelName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Levels_ML.ColumnNames.RowID;
					ht[LevelID] = _Levels_ML.ColumnNames.LevelID;
					ht[LanguageID] = _Levels_ML.ColumnNames.LanguageID;
					ht[LevelName] = _Levels_ML.ColumnNames.LevelName;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Levels_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Levels_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Levels_MLDelete]";
