<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TemporaryUsersTestResults.aspx.cs" Inherits="TemporaryUsers_TemporaryUsersTestResults" %>

<%@ Register Src="../UserControls/Employee/Membership/uTestResults.ascx" TagName="uTestResults"
    TagPrefix="uc1" %>
...
<body>
    ...
    <div id="contentPad" style="padding: 20px; text-align: left;">
        <uc1:uTestResults ID="UTestResults1" runat="server" />
