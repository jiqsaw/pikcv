...
namespace PIKCV.DAL
{
	public abstract class _UserProhibitedCompanies : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _UserProhibitedCompanies()
		{
			this.QuerySource = "UserProhibitedCompanies";
			this.MappingName = "UserProhibitedCompanies";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserProhibitedCompaniesLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserProhibitedCompaniesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _UserProhibitedCompanies.PropertyNames.RowID;
					ht[UserID] = _UserProhibitedCompanies.PropertyNames.UserID;
					ht[CompanyID] = _UserProhibitedCompanies.PropertyNames.CompanyID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _UserProhibitedCompanies.ColumnNames.RowID;
					ht[UserID] = _UserProhibitedCompanies.ColumnNames.UserID;
					ht[CompanyID] = _UserProhibitedCompanies.ColumnNames.CompanyID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserProhibitedCompaniesInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserProhibitedCompaniesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserProhibitedCompaniesDelete]";
