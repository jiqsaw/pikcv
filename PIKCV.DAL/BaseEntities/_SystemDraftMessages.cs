...
namespace PIKCV.DAL
{
	public abstract class _SystemDraftMessages : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _SystemDraftMessages()
		{
			this.QuerySource = "SystemDraftMessages";
			this.MappingName = "SystemDraftMessages";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SystemDraftMessagesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int SystemDraftMessageID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.SystemDraftMessageID, SystemDraftMessageID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SystemDraftMessagesLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter SystemDraftMessageID
			{
				get
				{
					return new SqlParameter("@SystemDraftMessageID", SqlDbType.Int, 0);
				}
			}
			...
			public static SqlParameter ModifiedBy
			{
				get
				{
					return new SqlParameter("@ModifiedBy", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string SystemDraftMessageID = "SystemDraftMessageID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[SystemDraftMessageID] = _SystemDraftMessages.PropertyNames.SystemDraftMessageID;
					ht[MessageName] = _SystemDraftMessages.PropertyNames.MessageName;
					ht[Subject] = _SystemDraftMessages.PropertyNames.Subject;
					ht[Message] = _SystemDraftMessages.PropertyNames.Message;
					ht[CreateDate] = _SystemDraftMessages.PropertyNames.CreateDate;
					ht[ModifyDate] = _SystemDraftMessages.PropertyNames.ModifyDate;
					ht[ModifiedBy] = _SystemDraftMessages.PropertyNames.ModifiedBy;
					ht[IsDeleted] = _SystemDraftMessages.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[SystemDraftMessageID] = _SystemDraftMessages.ColumnNames.SystemDraftMessageID;
					ht[MessageName] = _SystemDraftMessages.ColumnNames.MessageName;
					ht[Subject] = _SystemDraftMessages.ColumnNames.Subject;
					ht[Message] = _SystemDraftMessages.ColumnNames.Message;
					ht[CreateDate] = _SystemDraftMessages.ColumnNames.CreateDate;
					ht[ModifyDate] = _SystemDraftMessages.ColumnNames.ModifyDate;
					ht[ModifiedBy] = _SystemDraftMessages.ColumnNames.ModifiedBy;
					ht[IsDeleted] = _SystemDraftMessages.ColumnNames.IsDeleted;
		...
		{  
            public const string SystemDraftMessageID = "s_SystemDraftMessageID";
		...
		public virtual int SystemDraftMessageID
	    {
			get
	        {
				return base.Getint(ColumnNames.SystemDraftMessageID);
			}
			set
	        {
				base.Setint(ColumnNames.SystemDraftMessageID, value);
			}
		}
		...
		public virtual int ModifiedBy
	    {
			get
	        {
				return base.Getint(ColumnNames.ModifiedBy);
			}
			set
	        {
				base.Setint(ColumnNames.ModifiedBy, value);
			}
		}
		...
		public virtual string s_SystemDraftMessageID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.SystemDraftMessageID) ? string.Empty : base.GetintAsString(ColumnNames.SystemDraftMessageID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.SystemDraftMessageID);
				else
					this.SystemDraftMessageID = base.SetintAsString(ColumnNames.SystemDraftMessageID, value);
			}
		}
		...
		public virtual string s_ModifiedBy
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.ModifiedBy) ? string.Empty : base.GetintAsString(ColumnNames.ModifiedBy);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.ModifiedBy = base.SetintAsString(ColumnNames.ModifiedBy, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter SystemDraftMessageID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.SystemDraftMessageID, Parameters.SystemDraftMessageID);
			...
			public WhereParameter SystemDraftMessageID
		    {
				get
		        {
					if(_SystemDraftMessageID_W == null)
	        	    {
						_SystemDraftMessageID_W = TearOff.SystemDraftMessageID;
					}
					return _SystemDraftMessageID_W;
				}
			}
			...
			private WhereParameter _SystemDraftMessageID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter SystemDraftMessageID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.SystemDraftMessageID, Parameters.SystemDraftMessageID);
			...
			private AggregateParameter _SystemDraftMessageID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SystemDraftMessagesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.SystemDraftMessageID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SystemDraftMessagesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SystemDraftMessagesDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.SystemDraftMessageID);
			p.SourceColumn = ColumnNames.SystemDraftMessageID;
