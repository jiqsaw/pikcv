<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uInterests.ascx.cs" Inherits="UserControls_Employee_Membership_CV_uInterests" %>
...
<div class="ContentColB">
    ...
    <table width="100%" class="FormTable">
        <tr>
            <td colspan="2">
                <p>
                    Ýlgi Alanlarýnýz</p> <br />

                <asp:TextBox runat="server" ID="txtInterests" TextMode="multiLine" Width="480" Rows="6" MaxLength="2048"></asp:TextBox>           
