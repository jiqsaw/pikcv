...
namespace PIKCV.DAL
{
	public abstract class _ForeignLanguages : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _ForeignLanguages()
		{
			this.QuerySource = "ForeignLanguages";
			this.MappingName = "ForeignLanguages";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ForeignLanguagesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ForeignLanguageID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ForeignLanguageID, ForeignLanguageID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ForeignLanguagesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ForeignLanguageID] = _ForeignLanguages.PropertyNames.ForeignLanguageID;
					ht[CreateDate] = _ForeignLanguages.PropertyNames.CreateDate;
					ht[ModifyDate] = _ForeignLanguages.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _ForeignLanguages.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _ForeignLanguages.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ForeignLanguageID] = _ForeignLanguages.ColumnNames.ForeignLanguageID;
					ht[CreateDate] = _ForeignLanguages.ColumnNames.CreateDate;
					ht[ModifyDate] = _ForeignLanguages.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _ForeignLanguages.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _ForeignLanguages.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguagesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ForeignLanguageID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguagesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ForeignLanguagesDelete]";
