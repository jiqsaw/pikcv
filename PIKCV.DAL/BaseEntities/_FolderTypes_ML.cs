...
namespace PIKCV.DAL
{
	public abstract class _FolderTypes_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _FolderTypes_ML()
		{
			this.QuerySource = "FolderTypes_ML";
			this.MappingName = "FolderTypes_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FolderTypes_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FolderTypes_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter FolderTypeName
			{
				get
				{
					return new SqlParameter("@FolderTypeName", SqlDbType.NVarChar, 128);
				}
			}
		...
		{  
            ...
            public const string FolderTypeName = "FolderTypeName";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _FolderTypes_ML.PropertyNames.RowID;
					ht[FolderTypeID] = _FolderTypes_ML.PropertyNames.FolderTypeID;
					ht[LanguageID] = _FolderTypes_ML.PropertyNames.LanguageID;
					ht[FolderTypeName] = _FolderTypes_ML.PropertyNames.FolderTypeName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _FolderTypes_ML.ColumnNames.RowID;
					ht[FolderTypeID] = _FolderTypes_ML.ColumnNames.FolderTypeID;
					ht[LanguageID] = _FolderTypes_ML.ColumnNames.LanguageID;
					ht[FolderTypeName] = _FolderTypes_ML.ColumnNames.FolderTypeName;
		...
		{  
            ...
            public const string FolderTypeName = "s_FolderTypeName";
		...
		public virtual string FolderTypeName
	    {
			get
	        {
				return base.Getstring(ColumnNames.FolderTypeName);
			}
			set
	        {
				base.Setstring(ColumnNames.FolderTypeName, value);
			}
		}
		...
		public virtual string s_FolderTypeName
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.FolderTypeName) ? string.Empty : base.GetstringAsString(ColumnNames.FolderTypeName);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.FolderTypeName);
				else
					this.FolderTypeName = base.SetstringAsString(ColumnNames.FolderTypeName, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter FolderTypeName
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.FolderTypeName, Parameters.FolderTypeName);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter FolderTypeName
		    {
				get
		        {
					if(_FolderTypeName_W == null)
	        	    {
						_FolderTypeName_W = TearOff.FolderTypeName;
					}
					return _FolderTypeName_W;
				}
			}
			...
			private WhereParameter _FolderTypeName_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter FolderTypeName
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.FolderTypeName, Parameters.FolderTypeName);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _FolderTypeName_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypes_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypes_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypes_MLDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.FolderTypeName);
			p.SourceColumn = ColumnNames.FolderTypeName;
			p.SourceVersion = DataRowVersion.Current;
