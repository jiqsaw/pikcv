...
namespace PIKCV.DAL
{
	public abstract class _Departments_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Departments_ML()
		{
			this.QuerySource = "Departments_ML";
			this.MappingName = "Departments_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Departments_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Departments_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter DepartmentName
			{
				get
				{
					return new SqlParameter("@DepartmentName", SqlDbType.NVarChar, 64);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Departments_ML.PropertyNames.RowID;
					ht[DepartmentID] = _Departments_ML.PropertyNames.DepartmentID;
					ht[LanguageID] = _Departments_ML.PropertyNames.LanguageID;
					ht[DepartmentName] = _Departments_ML.PropertyNames.DepartmentName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Departments_ML.ColumnNames.RowID;
					ht[DepartmentID] = _Departments_ML.ColumnNames.DepartmentID;
					ht[LanguageID] = _Departments_ML.ColumnNames.LanguageID;
					ht[DepartmentName] = _Departments_ML.ColumnNames.DepartmentName;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Departments_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Departments_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Departments_MLDelete]";
