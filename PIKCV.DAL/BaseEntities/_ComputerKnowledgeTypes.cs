...
namespace PIKCV.DAL
{
	public abstract class _ComputerKnowledgeTypes : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _ComputerKnowledgeTypes()
		{
			this.QuerySource = "ComputerKnowledgeTypes";
			this.MappingName = "ComputerKnowledgeTypes";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ComputerKnowledgeTypesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ComputerKnowledgeTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ComputerKnowledgeTypeID, ComputerKnowledgeTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ComputerKnowledgeTypesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ComputerKnowledgeTypeID] = _ComputerKnowledgeTypes.PropertyNames.ComputerKnowledgeTypeID;
					ht[CreateDate] = _ComputerKnowledgeTypes.PropertyNames.CreateDate;
					ht[ModifyDate] = _ComputerKnowledgeTypes.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _ComputerKnowledgeTypes.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _ComputerKnowledgeTypes.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ComputerKnowledgeTypeID] = _ComputerKnowledgeTypes.ColumnNames.ComputerKnowledgeTypeID;
					ht[CreateDate] = _ComputerKnowledgeTypes.ColumnNames.CreateDate;
					ht[ModifyDate] = _ComputerKnowledgeTypes.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _ComputerKnowledgeTypes.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _ComputerKnowledgeTypes.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComputerKnowledgeTypesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ComputerKnowledgeTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComputerKnowledgeTypesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ComputerKnowledgeTypesDelete]";
