...
namespace PIKCV.DAL
{
	public abstract class _DriverLicenseTypes : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _DriverLicenseTypes()
		{
			this.QuerySource = "DriverLicenseTypes";
			this.MappingName = "DriverLicenseTypes";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int DriverLicenseTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.DriverLicenseTypeID, DriverLicenseTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[DriverLicenseTypeID] = _DriverLicenseTypes.PropertyNames.DriverLicenseTypeID;
					ht[IsDeleted] = _DriverLicenseTypes.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[DriverLicenseTypeID] = _DriverLicenseTypes.ColumnNames.DriverLicenseTypeID;
					ht[IsDeleted] = _DriverLicenseTypes.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.DriverLicenseTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypesDelete]";
