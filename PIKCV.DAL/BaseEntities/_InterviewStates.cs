...
namespace PIKCV.DAL
{
	public abstract class _InterviewStates : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _InterviewStates()
		{
			this.QuerySource = "InterviewStates";
			this.MappingName = "InterviewStates";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InterviewStatesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int InterviewStatusID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.InterviewStatusID, InterviewStatusID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InterviewStatesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[InterviewStatusID] = _InterviewStates.PropertyNames.InterviewStatusID;
					ht[IsDeleted] = _InterviewStates.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[InterviewStatusID] = _InterviewStates.ColumnNames.InterviewStatusID;
					ht[IsDeleted] = _InterviewStates.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStatesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.InterviewStatusID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStatesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStatesDelete]";
