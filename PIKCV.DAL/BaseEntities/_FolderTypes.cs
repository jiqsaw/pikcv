...
namespace PIKCV.DAL
{
	public abstract class _FolderTypes : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _FolderTypes()
		{
			this.QuerySource = "FolderTypes";
			this.MappingName = "FolderTypes";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FolderTypesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int FolderTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.FolderTypeID, FolderTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FolderTypesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[FolderTypeID] = _FolderTypes.PropertyNames.FolderTypeID;
					ht[CreateDate] = _FolderTypes.PropertyNames.CreateDate;
					ht[ModifyDate] = _FolderTypes.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _FolderTypes.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _FolderTypes.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[FolderTypeID] = _FolderTypes.ColumnNames.FolderTypeID;
					ht[CreateDate] = _FolderTypes.ColumnNames.CreateDate;
					ht[ModifyDate] = _FolderTypes.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _FolderTypes.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _FolderTypes.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.FolderTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FolderTypesDelete]";
