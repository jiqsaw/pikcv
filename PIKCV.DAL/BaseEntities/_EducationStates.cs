...
namespace PIKCV.DAL
{
	public abstract class _EducationStates : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _EducationStates()
		{
			this.QuerySource = "EducationStates";
			this.MappingName = "EducationStates";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_EducationStatesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int EducationStatusID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.EducationStatusID, EducationStatusID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_EducationStatesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[EducationStatusID] = _EducationStates.PropertyNames.EducationStatusID;
					ht[IsDeleted] = _EducationStates.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[EducationStatusID] = _EducationStates.ColumnNames.EducationStatusID;
					ht[IsDeleted] = _EducationStates.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_EducationStatesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.EducationStatusID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_EducationStatesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_EducationStatesDelete]";
