...
namespace PIKCV.DAL
{
	public abstract class _JobChoiceSectors : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _JobChoiceSectors()
		{
			this.QuerySource = "JobChoiceSectors";
			this.MappingName = "JobChoiceSectors";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceSectorsLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceSectorsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceSectors.PropertyNames.RowID;
					ht[JobID] = _JobChoiceSectors.PropertyNames.JobID;
					ht[SectorID] = _JobChoiceSectors.PropertyNames.SectorID;
					ht[Points] = _JobChoiceSectors.PropertyNames.Points;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceSectors.ColumnNames.RowID;
					ht[JobID] = _JobChoiceSectors.ColumnNames.JobID;
					ht[SectorID] = _JobChoiceSectors.ColumnNames.SectorID;
					ht[Points] = _JobChoiceSectors.ColumnNames.Points;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceSectorsInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceSectorsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceSectorsDelete]";
