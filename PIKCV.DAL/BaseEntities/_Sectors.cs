...
namespace PIKCV.DAL
{
	public abstract class _Sectors : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Sectors()
		{
			this.QuerySource = "Sectors";
			this.MappingName = "Sectors";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SectorsLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int SectorID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SectorsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[SectorID] = _Sectors.PropertyNames.SectorID;
					ht[CreateDate] = _Sectors.PropertyNames.CreateDate;
					ht[ModifyDate] = _Sectors.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _Sectors.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _Sectors.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[SectorID] = _Sectors.ColumnNames.SectorID;
					ht[CreateDate] = _Sectors.ColumnNames.CreateDate;
					ht[ModifyDate] = _Sectors.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _Sectors.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _Sectors.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SectorsInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SectorsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SectorsDelete]";
