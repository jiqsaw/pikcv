...
namespace PIKCV.DAL
{
	public abstract class _JobChoiceEducations : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _JobChoiceEducations()
		{
			this.QuerySource = "JobChoiceEducations";
			this.MappingName = "JobChoiceEducations";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceEducationsLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceEducationsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceEducations.PropertyNames.RowID;
					ht[JobID] = _JobChoiceEducations.PropertyNames.JobID;
					ht[EducationLevelID] = _JobChoiceEducations.PropertyNames.EducationLevelID;
					ht[Points] = _JobChoiceEducations.PropertyNames.Points;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceEducations.ColumnNames.RowID;
					ht[JobID] = _JobChoiceEducations.ColumnNames.JobID;
					ht[EducationLevelID] = _JobChoiceEducations.ColumnNames.EducationLevelID;
					ht[Points] = _JobChoiceEducations.ColumnNames.Points;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEducationsInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEducationsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEducationsDelete]";
