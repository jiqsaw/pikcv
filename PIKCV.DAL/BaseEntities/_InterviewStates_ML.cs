...
namespace PIKCV.DAL
{
	public abstract class _InterviewStates_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _InterviewStates_ML()
		{
			this.QuerySource = "InterviewStates_ML";
			this.MappingName = "InterviewStates_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InterviewStates_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InterviewStates_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter InterviewStatusName
			{
				get
				{
					return new SqlParameter("@InterviewStatusName", SqlDbType.NVarChar, 32);
				}
			}
		...
		{  
            ...
            public const string InterviewStatusName = "InterviewStatusName";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _InterviewStates_ML.PropertyNames.RowID;
					ht[InterviewStatusID] = _InterviewStates_ML.PropertyNames.InterviewStatusID;
					ht[LanguageID] = _InterviewStates_ML.PropertyNames.LanguageID;
					ht[InterviewStatusName] = _InterviewStates_ML.PropertyNames.InterviewStatusName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _InterviewStates_ML.ColumnNames.RowID;
					ht[InterviewStatusID] = _InterviewStates_ML.ColumnNames.InterviewStatusID;
					ht[LanguageID] = _InterviewStates_ML.ColumnNames.LanguageID;
					ht[InterviewStatusName] = _InterviewStates_ML.ColumnNames.InterviewStatusName;
		...
		{  
            ...
            public const string InterviewStatusName = "s_InterviewStatusName";
		...
		public virtual string InterviewStatusName
	    {
			get
	        {
				return base.Getstring(ColumnNames.InterviewStatusName);
			}
			set
	        {
				base.Setstring(ColumnNames.InterviewStatusName, value);
			}
		}
		...
		public virtual string s_InterviewStatusName
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.InterviewStatusName) ? string.Empty : base.GetstringAsString(ColumnNames.InterviewStatusName);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.InterviewStatusName);
				else
					this.InterviewStatusName = base.SetstringAsString(ColumnNames.InterviewStatusName, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter InterviewStatusName
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.InterviewStatusName, Parameters.InterviewStatusName);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter InterviewStatusName
		    {
				get
		        {
					if(_InterviewStatusName_W == null)
	        	    {
						_InterviewStatusName_W = TearOff.InterviewStatusName;
					}
					return _InterviewStatusName_W;
				}
			}
			...
			private WhereParameter _InterviewStatusName_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter InterviewStatusName
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.InterviewStatusName, Parameters.InterviewStatusName);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _InterviewStatusName_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStates_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStates_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InterviewStates_MLDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.InterviewStatusName);
			p.SourceColumn = ColumnNames.InterviewStatusName;
			p.SourceVersion = DataRowVersion.Current;
