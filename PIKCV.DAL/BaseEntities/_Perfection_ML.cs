...
namespace PIKCV.DAL
{
	public abstract class _Perfection_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Perfection_ML()
		{
			this.QuerySource = "Perfection_ML";
			this.MappingName = "Perfection_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Perfection_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Perfection_MLLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Perfection_ML.PropertyNames.RowID;
					ht[PerfectionID] = _Perfection_ML.PropertyNames.PerfectionID;
					ht[LanguageID] = _Perfection_ML.PropertyNames.LanguageID;
					ht[PerfectionName] = _Perfection_ML.PropertyNames.PerfectionName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Perfection_ML.ColumnNames.RowID;
					ht[PerfectionID] = _Perfection_ML.ColumnNames.PerfectionID;
					ht[LanguageID] = _Perfection_ML.ColumnNames.LanguageID;
					ht[PerfectionName] = _Perfection_ML.ColumnNames.PerfectionName;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfection_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfection_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfection_MLDelete]";
