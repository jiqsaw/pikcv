...
namespace PIKCV.DAL
{
	public abstract class _Perfections : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Perfections()
		{
			this.QuerySource = "Perfections";
			this.MappingName = "Perfections";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PerfectionsLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int PerfectionID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.PerfectionID, PerfectionID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PerfectionsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PerfectionID] = _Perfections.PropertyNames.PerfectionID;
					ht[CreateDate] = _Perfections.PropertyNames.CreateDate;
					ht[ModifyDate] = _Perfections.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _Perfections.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _Perfections.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PerfectionID] = _Perfections.ColumnNames.PerfectionID;
					ht[CreateDate] = _Perfections.ColumnNames.CreateDate;
					ht[ModifyDate] = _Perfections.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _Perfections.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _Perfections.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionsInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.PerfectionID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionsDelete]";
