...
namespace PIKCV.DAL
{
	public abstract class _LabouringTypes : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _LabouringTypes()
		{
			this.QuerySource = "LabouringTypes";
			this.MappingName = "LabouringTypes";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_LabouringTypesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int LabouringTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.LabouringTypeID, LabouringTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_LabouringTypesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[LabouringTypeID] = _LabouringTypes.PropertyNames.LabouringTypeID;
					ht[IsDeleted] = _LabouringTypes.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[LabouringTypeID] = _LabouringTypes.ColumnNames.LabouringTypeID;
					ht[IsDeleted] = _LabouringTypes.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_LabouringTypesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.LabouringTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_LabouringTypesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_LabouringTypesDelete]";
