...
namespace PIKCV.DAL
{
	public abstract class _Hobbies : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Hobbies()
		{
			this.QuerySource = "Hobbies";
			this.MappingName = "Hobbies";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_HobbiesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int HobbyID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.HobbyID, HobbyID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_HobbiesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[HobbyID] = _Hobbies.PropertyNames.HobbyID;
					ht[CreateDate] = _Hobbies.PropertyNames.CreateDate;
					ht[ModifyDate] = _Hobbies.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _Hobbies.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _Hobbies.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[HobbyID] = _Hobbies.ColumnNames.HobbyID;
					ht[CreateDate] = _Hobbies.ColumnNames.CreateDate;
					ht[ModifyDate] = _Hobbies.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _Hobbies.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _Hobbies.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_HobbiesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.HobbyID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_HobbiesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_HobbiesDelete]";
