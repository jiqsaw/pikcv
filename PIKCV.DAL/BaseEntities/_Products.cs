	...
	public abstract class _Products : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter QuantityPerUnit
			{
				get
				{
					return new SqlParameter("@QuantityPerUnit", SqlDbType.NVarChar, 50);
				}
			}
			...
			public static SqlParameter UnitsInStock
			{
				get
				{
					return new SqlParameter("@UnitsInStock", SqlDbType.Int, 0);
				}
			}
			...
			public static SqlParameter UnitsOnOrder
			{
				get
				{
					return new SqlParameter("@UnitsOnOrder", SqlDbType.Int, 0);
				}
			}
			...
			public static SqlParameter Discontinued
			{
				get
				{
					return new SqlParameter("@Discontinued", SqlDbType.Int, 0);
				}
			}
		...
		public virtual int UnitsInStock
	    {
			get
	        {
				return base.Getint(ColumnNames.UnitsInStock);
			}
			set
	        {
				base.Setint(ColumnNames.UnitsInStock, value);
			}
		}
		...
		public virtual int UnitsOnOrder
	    {
			get
	        {
				return base.Getint(ColumnNames.UnitsOnOrder);
			}
			set
	        {
				base.Setint(ColumnNames.UnitsOnOrder, value);
			}
		}
		...
		public virtual int Discontinued
	    {
			get
	        {
				return base.Getint(ColumnNames.Discontinued);
			}
			set
	        {
				base.Setint(ColumnNames.Discontinued, value);
			}
		}
		...
		public virtual string s_UnitsInStock
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.UnitsInStock) ? string.Empty : base.GetintAsString(ColumnNames.UnitsInStock);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.UnitsInStock = base.SetintAsString(ColumnNames.UnitsInStock, value);
			}
		}
		...
		public virtual string s_UnitsOnOrder
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.UnitsOnOrder) ? string.Empty : base.GetintAsString(ColumnNames.UnitsOnOrder);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.UnitsOnOrder = base.SetintAsString(ColumnNames.UnitsOnOrder, value);
			}
		}
		...
		public virtual string s_Discontinued
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Discontinued) ? string.Empty : base.GetintAsString(ColumnNames.Discontinued);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.Discontinued = base.SetintAsString(ColumnNames.Discontinued, value);
			}
		}
