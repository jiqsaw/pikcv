...
namespace PIKCV.DAL
{
	public abstract class _Perfections_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Perfections_ML()
		{
			this.QuerySource = "Perfections_ML";
			this.MappingName = "Perfections_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Perfections_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Perfections_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter PerfectionName
			{
				get
				{
					return new SqlParameter("@PerfectionName", SqlDbType.NVarChar, 64);
				}
			}
		...
		{  
            ...
            public const string PerfectionName = "PerfectionName";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Perfections_ML.PropertyNames.RowID;
					ht[PerfectionID] = _Perfections_ML.PropertyNames.PerfectionID;
					ht[LanguageID] = _Perfections_ML.PropertyNames.LanguageID;
					ht[PerfectionName] = _Perfections_ML.PropertyNames.PerfectionName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _Perfections_ML.ColumnNames.RowID;
					ht[PerfectionID] = _Perfections_ML.ColumnNames.PerfectionID;
					ht[LanguageID] = _Perfections_ML.ColumnNames.LanguageID;
					ht[PerfectionName] = _Perfections_ML.ColumnNames.PerfectionName;
		...
		{  
            ...
            public const string PerfectionName = "s_PerfectionName";
		...
		public virtual string PerfectionName
	    {
			get
	        {
				return base.Getstring(ColumnNames.PerfectionName);
			}
			set
	        {
				base.Setstring(ColumnNames.PerfectionName, value);
			}
		}
		...
		public virtual string s_PerfectionName
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.PerfectionName) ? string.Empty : base.GetstringAsString(ColumnNames.PerfectionName);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.PerfectionName);
				else
					this.PerfectionName = base.SetstringAsString(ColumnNames.PerfectionName, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter PerfectionName
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.PerfectionName, Parameters.PerfectionName);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter PerfectionName
		    {
				get
		        {
					if(_PerfectionName_W == null)
	        	    {
						_PerfectionName_W = TearOff.PerfectionName;
					}
					return _PerfectionName_W;
				}
			}
			...
			private WhereParameter _PerfectionName_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter PerfectionName
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.PerfectionName, Parameters.PerfectionName);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _PerfectionName_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfections_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfections_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Perfections_MLDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.PerfectionName);
			p.SourceColumn = ColumnNames.PerfectionName;
			p.SourceVersion = DataRowVersion.Current;
