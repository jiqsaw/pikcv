...
namespace PIKCV.DAL
{
	public abstract class _Perfection : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _Perfection()
		{
			this.QuerySource = "Perfection";
			this.MappingName = "Perfection";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PerfectionLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int PerfectionID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PerfectionLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PerfectionID] = _Perfection.PropertyNames.PerfectionID;
					ht[CreateDate] = _Perfection.PropertyNames.CreateDate;
					ht[ModifyDate] = _Perfection.PropertyNames.ModifyDate;
					ht[UpdatedBy] = _Perfection.PropertyNames.UpdatedBy;
					ht[IsDeleted] = _Perfection.PropertyNames.IsDeleted;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PerfectionID] = _Perfection.ColumnNames.PerfectionID;
					ht[CreateDate] = _Perfection.ColumnNames.CreateDate;
					ht[ModifyDate] = _Perfection.ColumnNames.ModifyDate;
					ht[UpdatedBy] = _Perfection.ColumnNames.UpdatedBy;
					ht[IsDeleted] = _Perfection.ColumnNames.IsDeleted;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PerfectionDelete]";
