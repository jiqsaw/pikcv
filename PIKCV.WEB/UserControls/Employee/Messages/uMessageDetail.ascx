<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uMessageDetail.ascx.cs" Inherits="UserControls_Employee_Messages_uMessageDetail" %>
          ...
          <table width="100%" class="GenericTable">
            ...
            <tr>
              ...
              <td><ul class="FamLinks">
                  ...
                  <li class="GoBack"><a href="#Employee-Messages-Messages">Mesaj Listesine Geri Dön</a></li>
