<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uSendMessageDetail.ascx.cs" Inherits="UserControls_Company_Messages_uSendMessageDetail" %>
      ...
      <div class="BoxContent">
        <div class="BoxPadder">
          <table width="100%" class="GenericTable">
            ...
            <tr>
              <td align="right" valign="top" nowrap="nowrap"><p><strong>Gönderilen:</strong></p></td>
              <td><p><asp:Label ID="lbMessageOwner" runat="server"></asp:Label></p></td>
            </tr>
            <tr> </tr>
            <tr>
