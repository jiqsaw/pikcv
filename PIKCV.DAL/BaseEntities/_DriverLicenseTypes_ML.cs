...
namespace PIKCV.DAL
{
	public abstract class _DriverLicenseTypes_ML : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _DriverLicenseTypes_ML()
		{
			this.QuerySource = "DriverLicenseTypes_ML";
			this.MappingName = "DriverLicenseTypes_ML";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypes_MLLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypes_MLLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter DriverLicenseTypeName
			{
				get
				{
					return new SqlParameter("@DriverLicenseTypeName", SqlDbType.NVarChar, 16);
				}
			}
		...
		{  
            ...
            public const string DriverLicenseTypeName = "DriverLicenseTypeName";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _DriverLicenseTypes_ML.PropertyNames.RowID;
					ht[DriverLicenseTypeID] = _DriverLicenseTypes_ML.PropertyNames.DriverLicenseTypeID;
					ht[LanguageID] = _DriverLicenseTypes_ML.PropertyNames.LanguageID;
					ht[DriverLicenseTypeName] = _DriverLicenseTypes_ML.PropertyNames.DriverLicenseTypeName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _DriverLicenseTypes_ML.ColumnNames.RowID;
					ht[DriverLicenseTypeID] = _DriverLicenseTypes_ML.ColumnNames.DriverLicenseTypeID;
					ht[LanguageID] = _DriverLicenseTypes_ML.ColumnNames.LanguageID;
					ht[DriverLicenseTypeName] = _DriverLicenseTypes_ML.ColumnNames.DriverLicenseTypeName;
		...
		{  
            ...
            public const string DriverLicenseTypeName = "s_DriverLicenseTypeName";
		...
		public virtual string DriverLicenseTypeName
	    {
			get
	        {
				return base.Getstring(ColumnNames.DriverLicenseTypeName);
			}
			set
	        {
				base.Setstring(ColumnNames.DriverLicenseTypeName, value);
			}
		}
		...
		public virtual string s_DriverLicenseTypeName
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.DriverLicenseTypeName) ? string.Empty : base.GetstringAsString(ColumnNames.DriverLicenseTypeName);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.DriverLicenseTypeName);
				else
					this.DriverLicenseTypeName = base.SetstringAsString(ColumnNames.DriverLicenseTypeName, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter DriverLicenseTypeName
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.DriverLicenseTypeName, Parameters.DriverLicenseTypeName);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter DriverLicenseTypeName
		    {
				get
		        {
					if(_DriverLicenseTypeName_W == null)
	        	    {
						_DriverLicenseTypeName_W = TearOff.DriverLicenseTypeName;
					}
					return _DriverLicenseTypeName_W;
				}
			}
			...
			private WhereParameter _DriverLicenseTypeName_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter DriverLicenseTypeName
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.DriverLicenseTypeName, Parameters.DriverLicenseTypeName);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _DriverLicenseTypeName_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypes_MLInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypes_MLUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DriverLicenseTypes_MLDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.DriverLicenseTypeName);
			p.SourceColumn = ColumnNames.DriverLicenseTypeName;
			p.SourceVersion = DataRowVersion.Current;
