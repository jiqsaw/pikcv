...
namespace PIKCV.DAL
{
	public abstract class _JobChoiceEmployment : SqlClientEntity
	{
		private string m_SchemaStoredProcedure = "Pikcv].[";
		public _JobChoiceEmployment()
		{
			this.QuerySource = "JobChoiceEmployment";
			this.MappingName = "JobChoiceEmployment";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceEmploymentLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int RowID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_JobChoiceEmploymentLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceEmployment.PropertyNames.RowID;
					ht[JobID] = _JobChoiceEmployment.PropertyNames.JobID;
					ht[PositionID] = _JobChoiceEmployment.PropertyNames.PositionID;
					ht[Points] = _JobChoiceEmployment.PropertyNames.Points;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[RowID] = _JobChoiceEmployment.ColumnNames.RowID;
					ht[JobID] = _JobChoiceEmployment.ColumnNames.JobID;
					ht[PositionID] = _JobChoiceEmployment.ColumnNames.PositionID;
					ht[Points] = _JobChoiceEmployment.ColumnNames.Points;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEmploymentInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEmploymentUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_JobChoiceEmploymentDelete]";
