<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uEducationUniversity1.ascx.cs" Inherits="UserControls_Employee_Membership_CV_uEducationUniversity1" %>
...
<div class="ContentColB">
    <h1>
        Üniversite Bilgileri</h1>
        
        <asp:Panel runat="server" ID="pnlNoRecord" CssClass="infoMsg">
            <asp:Literal runat="server" ID="ltlNoRecord">
                <p> Þu an için üniversite kaydýnýz bulunmamaktadýr. </p>
            </asp:Literal>
        </asp:Panel>
        
        <asp:Panel runat="server" ID="pnlUniversityList" Visible="false">
        
            <asp:Repeater runat="server" ID="rptUniversityList" OnItemDataBound="rptUniversityList_ItemDataBound" OnItemCommand="rptUniversityList_ItemCommand">
                <HeaderTemplate>
